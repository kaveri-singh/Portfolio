...
export const metadata: Metadata = {
  title: "Kaveri Singh — Backend Engineer",
  description:
    "Portfolio of Kaveri Singh, a Java backend developer building secure, scalable REST APIs with Spring Boot, Spring Security, and MongoDB.",
};
